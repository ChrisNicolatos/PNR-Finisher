...
Friend Class ReadPNR
    ...
    End Sub
    Public Sub SendAllGDSEntries(ByVal WritePNR As Boolean, ByVal WriteDocs As Boolean, ByVal mflgExpiryDateOK As Boolean, dgvApis As DataGridView, AirlineEntries As TextBox)

        If mGDSCode = Config.GDSCode.GDSisAmadeus Then
            SendAllGDSEntries1A(WritePNR, WriteDocs, mflgExpiryDateOK, dgvApis, AirlineEntries)
        ElseIf mGDSCode = Config.GDSCode.GDSisGalileo Then
            SendAllGDSEntries1G(WritePNR, WriteDocs, mflgExpiryDateOK, dgvApis, AirlineEntries)
        Else
    ...
    Private Sub SendAllGDSEntries1A(ByVal WritePNR As Boolean, ByVal WriteDocs As Boolean, ByVal mflgExpiryDateOK As Boolean, dgvApis As DataGridView, AirlineEntries As TextBox)
        ...
        End Try
    End Sub
    Private Sub SendAllGDSEntries1G(ByVal WritePNR As Boolean, ByVal WriteDocs As Boolean, ByVal mflgExpiryDateOK As Boolean, dgvApis As DataGridView, AirlineEntries As TextBox)
        Try
            If WritePNR Then
                RemoveOldGDSEntries1G()

                SendGDSElement1G(mobjNewGDSElements.PhoneElement)
                SendGDSElement1G(mobjNewGDSElements.EmailElement)
                SendGDSElement1G(mobjNewGDSElements.AgentID)
                SendGDSElement1G(mobjNewGDSElements.AOH)
                SendGDSElement1G(mobjNewGDSElements.OpenSegment)
                SendGDSElement1G(mobjNewGDSElements.TicketElement)
                SendGDSElement1G(mobjNewGDSElements.OptionQueueElement)

                If mflgNewPNR Then
                    SendGDSElement1G(mobjNewGDSElements.SavingsElement)
                    SendGDSElement1G(mobjNewGDSElements.LossElement)
                End If

                SendGDSElement1G(mobjNewGDSElements.CustomerCode)
                SendGDSElement1G(mobjNewGDSElements.CustomerName)
                SendGDSElement1G(mobjNewGDSElements.SubDepartmentCode)
                SendGDSElement1G(mobjNewGDSElements.SubDepartmentName)
                SendGDSElement1G(mobjNewGDSElements.CRMCode)
                SendGDSElement1G(mobjNewGDSElements.CRMName)
                SendGDSElement1G(mobjNewGDSElements.VesselName)
                SendGDSElement1G(mobjNewGDSElements.VesselFlag)
                SendGDSElement1G(mobjNewGDSElements.VesselOSI)
                SendGDSElement1G(mobjNewGDSElements.Reference)
                SendGDSElement1G(mobjNewGDSElements.BookedBy)
                SendGDSElement1G(mobjNewGDSElements.Department)
                SendGDSElement1G(mobjNewGDSElements.ReasonForTravel)
                SendGDSElement1G(mobjNewGDSElements.CostCentre)
                SendGDSElement1G(mobjNewGDSElements.GalileoTrackingCode)
    ...
    Private Sub CloseOffPNR1G()
        ...
        Else
            MessageBox.Show(pResponse(0) & vbCrLf & pResponse(1))
        End If
    End Sub
    ...
    End Sub
    Private Sub SendGDSElement1G(ByVal pElement As GDSNew.Item)
        If mGDSCode <> Config.GDSCode.GDSisGalileo Then
            Throw New Exception("ReadPNR.SendGDSElement1G()" & vbCrLf & "Selected GDS is not Galileo")
        End If
        Dim Session As New Travelport.TravelData.Factory.GalileoDesktopFactory("SPG720", "MYCONNECTION", False, True, "SMRT")
